...
void BiquadChain::processBiquad(std::deque<double> &input, double * output, const int stride, const int count, const Biquad * coeffs){
...
void BiquadChain::processFourthOrderSections(const double * input, double * output, const int stride, const int count, const Biquad * coeffs){
