...
public:
    ...
    void processBiquad(std::deque<double> &input, double * output, const int stride, const int count, const Biquad * coeffs);
    
    // Extension for fourth order sections
    void processFourthOrderSections(const double * input, double * output, int stride, int count, const Biquad * coeffs);
